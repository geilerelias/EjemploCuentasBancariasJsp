                ...
                <div class=" container-fluid py-5 " style="height:90vh">
                    <div class="row justify-content-center ">
                        ...
                        <form class="form-inline">
                            ...
                            <button type="button" id="btnConfirmarIdentidad" class=" btn btn-primary mb-2 ">Confirmar
                            identitidad</button>
                        </form>
                    </div>
                    <div class="row justify-content-center ">
                        ...
                        <div class="card d-none" id="contenedorGestion">
                            <div class="card-body ">
                                <ul class="nav nav-tabs bg-primary" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link" id="registrar-cuenta-corriente-tab" data-toggle="tab" href="#registrar-cuenta-corriente" role="tab" aria-controls="registrar-cuenta-corriente" aria-selected="false">registrar
                                        cuenta corriente</a>

                                    </li>
                                    <li class="nav-item ">
                                        <a class="nav-link" id="consignar-tab" data-toggle="tab" href="#consignar-cuenta" role="tab" aria-controls="consignar-cuenta" aria-selected="false ">consignar a
                                        cuenta</a>
                                    </li>
                                    <li class="nav-item ">
                                        <a class="nav-link" id="retirar-tab" data-toggle="tab" href="#retirar-cuenta" role="tab" aria-controls="retirar-cuenta" aria-selected="false ">retirar de
                                        cuenta</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <div class="tab-pane fade " id="consignar-cuenta" role="tabpanel" aria-labelledby="consignar-tab">
                                        ...
                                        <div class="container">
                                            <form>
                                                <div class="form-group ">
                                                    <!-- left unspecified, .bmd-form-group will be automatically added (inspect the code) -->
                                                    <label for="txtNumeroTarjetaConsignar" class="bmd-label-floating ">Numero
                                                    Tarjeta</label>
                                                    <input type="number" class="form-control" id="txtNumeroTarjetaConsignar">
                                                </div>
                                                <div class="form-group ">
                                                    <!-- left unspecified, .bmd-form-group will be automatically added (inspect the code) -->
